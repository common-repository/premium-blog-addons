<?php
    ...
    if ( ! function_exists( 'fs_request_get' ) ) {
        /**
         * A Utilities method to fetch GET/POST user input with an optional default value when the input is not set.
        ...
        function fs_request_get( $key, $def = false, $type = false ) {
             ...
             *  This is a Utilities method to fetch GET/POST user input with an optional default value when the input is not set. The actual sanitization is done in the scope of the function's usage.
             */
            switch ( $type ) {
                case 'post':
    ...
    if ( ! function_exists( 'fs_request_get_bool' ) ) {
        /**
         * A Utilities method to fetch GET/POST user boolean input with an optional default value when the input is not set.
         *
         * @author Vova Feldman (@svovaf)
         *
         * @param string $key
