...
?>
<div class="premiumblog-author-box layout-<?php echo esc_attr($layout) ?><?php echo (esc_attr($settings['default_shadow'] == 'yes' ? ' has-shadow' : '')) ?>">
    <?php if('yes' === $settings['show_avatar']): ?>
    <div class="pbw-avatar<?php echo (esc_attr($settings['show_avatar_border'] == 'yes' ? ' has-border' : '')) ?>">
        <?php
        if($avatar) {
