 ...
 * @since 1.0.0
 */
class premiumblog_Classic_Posts extends Widget_Base
{
    ...
    public function __construct($data = array(), $args = null)
    {
        ...
        wp_register_style('premiumblog-posts-classic', plugins_url('/assets/css/posts-classic.css', PBW_WIDGETS), array(), '1.0.0');
    }
    ...
    {
        return 'premiumblog_posts_classic';
    }
    ...
    {
        return __('Classic Posts', 'premium-blog');
    }
    ...
    {
        return 'pbw-icon premiumblog-icon-posts-classic';
    }
    ...
    {
        return array('premiumblog-posts-classic');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'premiumblog_post_list_widget_head_typography',
                'label' => __('Typography', 'premium-blog'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
                '{{WRAPPER}} .premiumblog-widget-head h3',
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#333333',
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .item-meta .post-title a' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#019625',
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .item-meta .post-title a:hover' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#555555',
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .list-meta-info' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .list-meta-info a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .list-meta-info i' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .item-meta' => 'text-align: {{VALUE}};',
                    '{{WRAPPER}} .premiumblog-posts-classic .item-meta .post-title' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'premiumblog_post_list_title_large_typography',
                'label' => __('Post Title (Large Grid)', 'premium-blog'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
                '{{WRAPPER}} .premiumblog-posts-classic .item-1 .item-meta .post-title',
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'label' => __('Post Title (Small Grids)', 'premium-blog'),
                'scheme' => Typography::TYPOGRAPHY_1,
                'selector' =>
                '{{WRAPPER}} .premiumblog-posts-classic .item-meta .post-title',
            ]
        );
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                ...
                'selector' => '{{WRAPPER}} .premiumblog-posts-classic .item-meta .post-desc',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .grid-post-term span.term-icon' => 'background-color: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .grid-post-term span.term-icon' => 'color: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .grid-post-term span.term-name' => 'background-color: {{VALUE}}',
                ],
                'default' => '#019625',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .premiumblog-posts-classic .list-item .grid-post-term span.term-name' => 'color: {{VALUE}}',
                ],
                'default' => '#000000',
            ]
        );
...
?>
        <div class="premiumblog-posts-classic-container">
            <?php
            ...
            <?php } ?>
            <div class="premiumblog-posts-classic layout-<?php echo esc_attr($layout) ?>">
                <?php
                ...
                ?>
                        <?php if ($i === 1) : ?>
                            <div class="list-item<?php echo (esc_attr($layout == 1 || $layout == 2 ? ' item-1' : '')) ?>">
                                <div class="item-thumb">
                                    <a href="<?php the_permalink() ?>">
                                        <?php
                                        if (has_post_thumbnail()) :
                                            the_post_thumbnail('premiumblog-classic-thumb-large');
                                        else :
                                            echo '<img src="' . PBW_ASSETS_PATH . 'img/thumb-medium.png">';
                                        endif;
                                        ?>
                                    </a>
                                    <?php
                                ...
                                <div class="item-meta">
                                    ...
                                    if ('yes' === $settings['show_excerpt']) { ?>
                                        <p class="post-desc"><?php echo esc_attr($layout == 1 || $layout == 2 ? Utilities::premiumblog_list_excerpt(25) : Utilities::premiumblog_list_excerpt(50)) ?></p>
                                    <?php } ?>
                        ...
                        <?php else : ?>
                            <div class="list-item">
                                ...
                                <div class="item-meta">
                                    ...
                                    <?php
                                    if ('yes' === $settings['show_excerpt']) { ?>
                                        <p class="post-desc"><?php echo esc_attr($layout == 1 || $layout == 2 ? Utilities::premiumblog_list_excerpt(15) : Utilities::premiumblog_list_excerpt(50)) ?></p>
                                    <?php } ?>
